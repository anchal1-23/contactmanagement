...
def OnSelected(event):
    ...
    lbl_title = Label(FormTitle, text="Updating Contacts", font=('arial', 16), bg="grey",  width = 300)
...
def AddNewWindow():
    ...
    lbl_title = Label(FormTitle, text="Adding New Contacts", font=('arial', 16), bg="grey",  width = 300)
    lbl_title.pack(fill=X)
    lbl_firstname = Label(ContactForm, text="Firstname", font=('arial', 14), bd=5)
    lbl_firstname.grid(row=0, sticky=W)
    lbl_lastname = Label(ContactForm, text="Lastname", font=('arial', 14), bd=5)
...
btn_add = Button(MidLeft, text="+ ADD NEW", bg="light pink", command=AddNewWindow)
btn_add.pack()
btn_delete = Button(MidRight, text="DELETE", bg="light pink", command=DeleteData)
